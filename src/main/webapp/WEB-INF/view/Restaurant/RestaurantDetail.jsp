...
<head>
    ...
    <link href="${pageContext.request.contextPath }/CSS/restaurant_datail.css" rel="stylesheet" type="text/css">
...
<body>
    <div class="wrap_contents">
        ...
        <div class="food_img">
            <img src="Restaurant/upfile/${rdto.restaurantImage }" alt="ymym" width="700" height="400">
        </div>
        <div class="res">
            <div class="res_info">
                <ul class="info">
        ...
        <div class="res_food_list">
            ...
            <ul class="re_menu">
                <li class="re_menu_li">
                    <input type="radio" name="chk" class="check" value="메뉴1">
                    <label for="" id="chk">메뉴이름</label>
                    <span><img src="../images/food.jpg" alt="" width="180" height="160"></span>
                    <div>
                        <p><span>가격</span>40,000원</p>
                    </div>
                    <a href="#" class=""><img src="../images/detail.png" alt="상세보기" width="100" height="12"></a>
                </li>
                <li class="re_menu_li">
                    <input type="radio" name="chk" class="check" value="메뉴2">
                    <label for="" id="chk">메뉴이름</label>
                    <span><img src="../images/food.jpg" alt="" width="180" height="160"></span>
                    <div>
                        <p><span>가격</span>40,000원</p>
                ...
                <li class="re_menu_li">
                    <input type="radio" name="chk" class="check" value="메뉴3">
                    <label for="" id="chk">메뉴이름</label>
                    <span><img src="../images/food.jpg" alt="" width="180" height="160"></span>
                    <div>
                        <p><span>가격</span>40,000원</p>
                ...
                <li class="re_menu_li">
                    <input type="radio" name="chk" class="check" value="메뉴4">
                    <label for="" id="chk">메뉴이름</label>
                    <span><img src="../images/food.jpg" alt="" width="180" height="160"></span>
                    <div>
                        <p><span>가격</span>40,000원</p>
        ...
        <div class="res_table">
            <div class="table_box">예약<br><br>
                <label for="" id="label">인원</label>
                <div id="t_box">
            ...
            <div class="chk_menu">선택한 예약 정보<br><br>
