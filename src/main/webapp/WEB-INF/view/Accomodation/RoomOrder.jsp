		...
		<div class="order">
			...
			<div class="order_info">
				<table>
					...
					<tr>
						<td rowspan="9">
						<img src="Restaurant/upfile/${command.roomImgstore }" alt="" width="400" height="400">
						</td>
					</tr>
					<tr>
						<td id="sub">타입</td>
						<td id="con">숙박<input type="hidden" value="숙박"> </td>
					</tr>
					<tr>
						<td id="sub">이름</td>
						<td id="con">${command.accomodationName }</td>
					</tr>
					<tr>
						<td id="sub">입실</td>
							...
							<td id="con"><fmt:formatDate pattern="yyyy-MM-dd"
									value="${command.checkin }" /><span style="color: red;"></span> 
					</tr>
					<tr>
						<td id="sub">퇴실</td>
							...
							<td id="con"><fmt:formatDate pattern="yyyy-MM-dd"
									value="${command.checkout }" /><span style="color: red;"></span> 
					</tr>					
					<tr>
						<td id="sub">가격</td>
						<td id="con">${command.roomPrice } 원</td>
					</tr>
					<tr>
						<td id="sub">옵션</td>
