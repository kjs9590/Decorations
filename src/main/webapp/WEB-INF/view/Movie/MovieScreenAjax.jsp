    ...
    <div class="footer">
          ...
          <%if(Charge !=null){ %>
           ...
           <div id=nowplaying>
                ...
                <h5> <input type="number"placeholder="상영관 행" name="screenRow"></h5> <h5><input type="number"placeholder="상영관 열" name="screenColum"></h5>
                <h5><select name="screenKind">
